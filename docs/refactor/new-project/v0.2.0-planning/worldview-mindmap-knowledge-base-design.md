...
对比后判断：固定世界节点不再拆成一级系统和二级模块，而是直接采用上述 9 个一级节点，减少用户需要维护的固定节点数。底层仍保留人物、势力、地点、规则、伏笔、事件等实体类型，避免导航层复杂度向用户暴露。
...
4. 百科仓库展示由导图节点派生的一级世界节点和示例条目，固定节点覆盖规则体系、地理地图、人物关系、势力阵营、风俗文化、矛盾冲突、事件年表、伏笔、灵感。
...
- 固定世界节点只保留一级：规则体系、地理地图、人物关系、势力阵营、风俗文化、矛盾冲突、事件年表、伏笔、灵感。
...
- 思维导图中的固定业务节点不能删除，只允许清空内容。固定业务节点包括规则体系、地理地图、人物关系、势力阵营、风俗文化、矛盾冲突、事件年表、伏笔、灵感。该策略用于减少删除固定目录后带来的百科条目失联、校验路径失效和演示流程断裂问题。
